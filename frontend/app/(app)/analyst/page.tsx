...
export default function AnalystPage(){
  ...
  return <><PageHeader title="AI-аналитик" subtitle="Ответы по проверяемым данным клиники — без доступа к пациентам и произвольному SQL" action={<button className="primary" onClick={()=>create.mutate()} disabled={create.isPending}>Новый диалог</button>}/>
