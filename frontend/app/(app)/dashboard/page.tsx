  ...
  return <>
    ...
    <DataState loading={dashboard.isLoading||pnl.isLoading} error={dashboard.error||pnl.error}>
      {dashboard.data&&pnl.data&&(()=>{
        ...
        return <>
          <CoverageBanner coverage={dashboard.data.finance.meta.coverage?.revenue_accrual} label="Выручка"/>
          <CoverageBanner coverage={dashboard.data.sales.meta.coverage?.patients_total} label="Пациенты"/>
