...
from app.modules.kcell.assignments_router import router as kcell_assignments_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    application.include_router(kcell_assignments_router, prefix=settings.api_v1_prefix)
