        ...
        dependency_order = case(
            {
                ...
                RECEPTION_ENTITY: 5,
                RETAIL_SALE_ENTITY: 5,
                PURCHASE_ENTITY: 5,
                INCOMING_PAYMENT_ENTITY: 5,
                OUTGOING_PAYMENT_ENTITY: 5,
                RECEPTION_SERVICE_ENTITY: 6,
                RETAIL_SALE_SERVICE_ENTITY: 6,
                INCOMING_PAYMENT_LINE_ENTITY: 6,
                OUTGOING_PAYMENT_LINE_ENTITY: 6,
                OUTGOING_PAYMENT_EXPENSE_LINE_ENTITY: 6,
                "AccumulationRegister_Продажи_RecordType": 7,
                "AccumulationRegister_Выручка_RecordType": 7,
                "AccumulationRegister_РасчетыСПерсоналом_RecordType": 7,
                "Document_НачислениеЗарплаты": 8,
                PAYROLL_EXPENSE_LINE_ENTITY: 9,
                "Document_НачислениеЗарплаты_РасчетЗарплаты": 10,
            },
    ...
    async def remove_one_c_canonical_record(
        ...
        *,
        ...
        model_by_entity = {
            ...
            PAYROLL_EXPENSE_LINE_ENTITY: PayrollFact,
            PURCHASE_ENTITY: ExpenseFact,
            RECEPTION_SERVICE_ENTITY: RevenueFact,
            RETAIL_SALE_SERVICE_ENTITY: RevenueFact,
            INCOMING_PAYMENT_LINE_ENTITY: RevenueFact,
            OUTGOING_PAYMENT_LINE_ENTITY: RevenueFact,
            OUTGOING_PAYMENT_EXPENSE_LINE_ENTITY: PayrollFact,
            OUTGOING_PAYMENT_ENTITY: PayrollFact,
            INCOMING_PAYMENT_ENTITY: PayrollFact,
        }
