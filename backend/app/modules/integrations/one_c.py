...
SAFE_ONE_C_ENTITIES = (
    ...
    "Document_НачислениеЗарплаты_Затраты",
    "Document_Прием",
    "Document_Прием_Лечение",
    "Document_Реализация",
    "Document_Реализация_Услуги",
    "Document_Поступление",
    "Document_ПоступлениеДенежныхСредств",
    "Document_ПоступлениеДенежныхСредств_РасшифровкаПлатежа",
    "Document_СписаниеДенежныхСредств",
    "Document_СписаниеДенежныхСредств_Затраты",
    "Document_СписаниеДенежныхСредств_РасшифровкаПлатежа",
...
SAFE_ONE_C_FIELDS: dict[str, frozenset[str]] = {
    ...
    "Catalog_ПричиныОтменыЗаписи": frozenset(("Ref_Key", "Description", "Code", "DeletionMark", "ИнициаторОтмены")),
    ...
    "Document_НачислениеЗарплаты_Затраты": frozenset(("Ref_Key", "LineNumber", "Дата", "Сотрудник_Key", "ВидНачисления", "Номенклатура_Key", "Сумма", "СтатьяРасходов_Key")),
    "Document_Прием": frozenset(("Ref_Key", "Number", "Date", "DeletionMark", "Posted", "Контрагент_Key", "Сотрудник_Key", "СтруктурнаяЕдиница_Key", "СуммаДокумента", "СуммаОплачено", "СтатусПациента", "ЭтоПервичныйПациентДляВрача")),
    "Document_Прием_Лечение": frozenset(("Ref_Key", "LineNumber", "Номенклатура_Key", "Количество", "Цена", "Сумма", "Всего", "Сотрудник_Key")),
    "Document_Реализация": frozenset(("Ref_Key", "Number", "Date", "DeletionMark", "Posted", "Контрагент_Key", "Сотрудник_Key", "СтруктурнаяЕдиница_Key", "СуммаДокумента", "СуммаОплачено")),
    "Document_Реализация_Услуги": frozenset(("Ref_Key", "LineNumber", "Номенклатура_Key", "Количество", "Цена", "Сумма", "Всего")),
    "Document_Поступление": frozenset(("Ref_Key", "Number", "Date", "DeletionMark", "Posted", "Контрагент_Key", "СтатьяЗатрат_Key", "СтруктурнаяЕдиница_Key", "СуммаДокумента", "СуммаОплачено", "Комментарий")),
    "Document_ПоступлениеДенежныхСредств": frozenset(("Ref_Key", "Number", "Date", "DeletionMark", "Posted", "ВидОперации", "Касса_Key", "БанковскийСчет_Key", "Контрагент", "Сотрудник_Key", "СтатьяДДС_Key", "СтруктурнаяЕдиница_Key", "СуммаДокумента", "ТипДенежныхСредств", "ВозвратВыплатыЗПМесяц")),
    "Document_ПоступлениеДенежныхСредств_РасшифровкаПлатежа": frozenset(("Ref_Key", "LineNumber", "Сотрудник_Key", "Сумма", "СтатьяДДС_Key", "ДокументОснования", "ДокументОснования_Type")),
    "Document_СписаниеДенежныхСредств": frozenset(("Ref_Key", "Number", "Date", "DeletionMark", "Posted", "ВидОперации", "Касса_Key", "БанковскийСчет_Key", "Контрагент", "Сотрудник_Key", "СтатьяДДС_Key", "СтруктурнаяЕдиница_Key", "СуммаДокумента", "ТипДенежныхСредств", "ВыплатаЗПМесяц", "Комментарий")),
    "Document_СписаниеДенежныхСредств_Затраты": frozenset(("Ref_Key", "LineNumber", "СтатьяЗатрат_Key", "Специализация_Key", "Сумма", "Сотрудник_Key")),
    "Document_СписаниеДенежныхСредств_РасшифровкаПлатежа": frozenset(("Ref_Key", "LineNumber", "Сотрудник_Key", "Сумма", "СтатьяДДС_Key", "ДокументОснования", "ДокументОснования_Type")),
