...
class IntegrationService:
    ...
    async def create_connection(
        ...
        if payload.provider == ONE_C_PROVIDER:
            # Never accept 1C credentials from the browser. Only a connector
            # token is issued (rotate_one_c_connector_token); the 1C-side
            # extension authenticates with it directly.
            settings = {
                "mode": "local_push",
            }
